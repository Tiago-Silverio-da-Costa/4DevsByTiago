            ...
            <div>
                ...
                <div v-if="step === 1">
                    <p class="text-white font-medium text-sm text-center">
                        Insert your email for the code verification.
                    </p>
                    <div class="w-full flex flex-col justify-center items-center mt-8">
                        <input class="w-full placeholder:pl-4 mt-4" placeholder="Email" />
                        <button @click="goToNextStep" type="submit"
                            class="w-full px-4 py-2 rounded-md bg-[#FF8200] font-bold mt-4">Send</button>
                    </div>
                </div>
                ...
                <div v-else-if="step === 2">
                    ...
                    <div class="w-full flex flex-col justify-center items-center mt-8">
                        ...
                        <button @click="goToNextStep" type="submit"
                            class="w-full px-4 py-2 rounded-md bg-[#FF8200] font-bold mt-4">Verify</button>
                    </div>
                </div>
                ...
                <div v-else-if="step === 3">
                    ...
                    <div class="w-full flex flex-col justify-center items-center mt-8">
                        ...
                        <input class="w-full placeholder:pl-4 mt-4" placeholder="Confirm New Password"
                            type="password" />
                        <button @click="resetSteps" type="submit"
                            class="w-full px-4 py-2 rounded-md bg-[#FF8200] font-bold mt-4">Reset Password</button>
                    </div>
                </div>
            </div>
        </div>
